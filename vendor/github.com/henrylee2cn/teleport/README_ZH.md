...
[更多示例](https://github.com/weblazy/teleport/blob/master/examples)
...
| package                                  | import                                   | description                              |
| ---------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| [auth](https://github.com/weblazy/teleport/tree/master/plugin/auth) | `import "github.com/weblazy/teleport/plugin/auth"` | A auth plugin for verifying peer at the first time |
...
| package                                  | import                                   | description                              |
| ---------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| [rawproto](https://github.com/weblazy/teleport/tree/master/proto/rawproto) | `import "github.com/weblazy/teleport/proto/rawproto` | 一个高性能的通信协议（teleport默认）|
| [jsonproto](https://github.com/weblazy/teleport/tree/master/proto/jsonproto) | `import "github.com/weblazy/teleport/proto/jsonproto"` | JSON 格式的通信协议     |
| [pbproto](https://github.com/weblazy/teleport/tree/master/proto/pbproto) | `import "github.com/weblazy/teleport/proto/pbproto"` | Protobuf 格式的通信协议     |
| [thriftproto](https://github.com/weblazy/teleport/tree/master/proto/thriftproto) | `import "github.com/weblazy/teleport/proto/thriftproto"` | Thrift 格式的通信协议     |
| [httproto](https://github.com/weblazy/teleport/tree/master/proto/httproto) | `import "github.com/weblazy/teleport/proto/httproto"` | HTTP 格式的通信协议     |
...
Teleport 项目采用商业应用友好的 [Apache2.0](https://github.com/weblazy/teleport/raw/master/LICENSE) 协议发布
